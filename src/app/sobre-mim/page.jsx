              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 bg-accent-50 rounded-lg">
                    <h3 className="text-2xl font-bold text-accent-600">100+</h3>
        ...
        <section className="text-center">
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex justify-center">
              <Link
                href="/listagem"
                className="inline-block bg-primary-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-600 transition-colors shadow-md hover:shadow-lg"
              >
                Ver Animais para Adoção
              </Link>
              <Link
                href="/contato"
                className="inline-block border-2 border-primary-500 text-primary-500 px-8 py-3 rounded-lg font-semibold hover:bg-primary-50 transition-colors shadow-md hover:shadow-lg"
              >
                Entre em Contato
              </Link>
            </div>
